  ...
  return (
    ...
    >
      ...
      >
        ...
        <Linha y="5%" jogadores={ataque} />

        <Linha y="30%" jogadores={meio} />

        <Linha y="54%" jogadores={defesa} />

        <Linha y="78%" jogadores={goleiro} />
      </div>
    </div>
  );
}
      ...
      {jogadores.map((j) => (
        ...
        >
          ...
          <input
            ...
            onBlur={(e) => {let value = parseFloat(e.target.value);
